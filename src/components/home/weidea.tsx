    ...
    return (
        <>
            <div className="mx-10 md:mx-32 py-10 flex flex-col items-center my-10">
                <div className="flex flex-col gap-40 lg:flex-row items-center text-center lg:text-left pb-16 md:pb-0 justify-between mt-16">
                    <Image src={Who} alt="" className="h-[35rem] w-auto"/>
                    <div>
                ...
                <div className="flex flex-col gap-40 lg:flex-row-reverse items-center text-center lg:text-left pb-16 md:pb-0 justify-between">
                    <Image src={Idea} alt="" className="h-[35rem] w-auto"/>
                    <div>
