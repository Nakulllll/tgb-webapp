        ...
        <>
            <div className="flex flex-col items-center mx-10 md:mx-32 overflow-auto">
                ...
                <div className="flex justify-center my-16 items-center">
                    <div className="bg-grey_bg mx-10 flex flex-col items-center w-1/4 px-20 py-10 rounded-3xl text-center">
                    <p>
                    ...
                    <div className="bg-grey_bg flex flex-col items-center w-1/4 px-20 py-10 rounded-3xl text-center">
                        <p>
                            Nakul sir, was a great help to get clarity about my entrepreneurial journey.
                            He was always a call away for all my problems, He is not only o me!
                        </p>
