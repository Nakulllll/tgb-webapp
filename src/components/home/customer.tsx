    ...
    return (
        <>
            <div className="flex flex-col items-center mx-10 md:mx-32 overflow-auto">
                ...
                <div className="flex flex-col gap-10 lg:flex-row justify-center my-16 items-center">

                    <div className="bg-grey_bg mx-10 flex flex-col items-center w-full lg:w-1/4 relative px-20 py-10 rounded-3xl text-center">
